<template>
<div>
    <button type="button" style="display:none" class="btn btn-primary" data-toggle="modal" data-target="#VolunteerActivities" ref="active">
    </button>
    <div class="modal fade" id="VolunteerActivities" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog  modal-xl dialog-all" role="document">
            <div class="modal-content body-dialog">
                <div class="modal-header text-header">
                    <h5 class="modal-title text-title">Hoạt động xã hội và tình nguyện</h5>
                 ...
                 <div class="modal-content body-dialog">
                    ...
                    <div class="twe-itemExp d-flex flex-row align-items-center justify-content-center">
